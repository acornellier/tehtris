...
namespace yaSingleton.Utility
{
    ...
    {
        [SerializeField] [HideInInspector] private bool _dontDestroyOnLoad;
        ...
        public new bool DontDestroyOnLoad
        {
            ...
            set
            {
                ...
                {
                    Debug.Log(
                        "Object already set to not destroy on load. This cannot be undone (you can destroy the object instead)."
                    );
                    return;
                }
